...
const Portfolio = () => {
  ...
  // Professional software development projects with optimized image sizes
  const portfolioProjects: PortfolioProject[] = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=75',
    ...
    },
    {
      ...
      description: language === 'en'
        ? 'Cross-platform mobile application for cryptocurrency trading with real-time data streams and secure wallet integration.'
        : 'Aplicación móvil multiplataforma para trading de criptomonedas con streams de datos en tiempo real e integración segura de wallet.',
      image: 'https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=75',
      categories: ['all', 'mobileAppsPortfolio', 'apiDesign'],
      techStack: ['React Native', 'TypeScript', 'GraphQL', 'WebSocket'],
      featured: true
    },
    {
      id: 3,
      ...
      description: language === 'en'
        ? 'Scalable API gateway with rate limiting, authentication, and load balancing for microservices architecture.'
        : 'Gateway de APIs escalable con limitación de velocidad, autenticación y balanceador de carga para arquitectura de microservicios.',
      image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=75',
    ...
    },
    {
      ...
      description: language === 'en'
        ? 'Automated ML pipeline for data processing, model training, and deployment with real-time monitoring capabilities.'
        : 'Pipeline ML automatizado para procesamiento de datos, entrenamiento de modelos y despliegue con capacidades de monitoreo en tiempo real.',
      image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=75',
      categories: ['all', 'aiMachineLearning', 'devOpsInfrastructure'],
      techStack: ['Python', 'TensorFlow', 'Apache Airflow', 'Docker'],
      featured: true
    },
    {
      id: 5,
      ...
      description: language === 'en'
        ? 'Serverless social media platform with real-time messaging and elastic scaling for millions of users.'
        : 'Plataforma de redes sociales serverless con mensajería en tiempo real y escalado elástico para millones de usuarios.',
      image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=75',
      categories: ['all', 'webApplications', 'cloudArchitecture'],
      techStack: ['Next.js', 'Serverless', 'DynamoDB', 'Lambda'],
      featured: false
    },
    {
      id: 6,
      ...
      description: language === 'en'
        ? 'Complete CI/CD automation platform with infrastructure as code and automated testing.'
        : 'Plataforma completa de automatización CI/CD con infraestructura como código y testing automatizado.',
      image: 'https://images.unsplash.com/photo-1518186285589-2f7649de83e0?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=75',
      categories: ['all', 'devOpsInfrastructure', 'cloudArchitecture'],
      techStack: ['Jenkins', 'Terraform', 'Ansible', 'Prometheus'],
      featured: false
    },
    {
      id: 7,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-text-secondary max-w-3xl mx-auto">
            {language === 'en' 
              ? 'Explore my latest software development projects featuring cutting-edge technologies and scalable architectures.'
              : 'Explora mis últimos proyectos de desarrollo de software con tecnologías de vanguardia y arquitecturas escalables.'
            }
          </p>
        </div>
        ...
        <Swiper
          ...
          navigation={true}
          autoplay={{
            delay: 6000, // Slower for better UX
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl p-8 border border-primary/20">
            ...
            <p className="text-text-secondary mb-6 max-w-2xl mx-auto">
              {language === 'en' 
                ? "Let's collaborate on your next software project. I bring expertise in modern technologies and best practices."
                : "Colaboremos en tu próximo proyecto de software. Aporto experiencia en tecnologías modernas y mejores prácticas."
              }
            </p>
            <a
              href="#contact"
